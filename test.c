...
// int main() {
//     printf("\033[1m\033[31mThis is a normal line.\033[0m\n");                       // Regular line in red
//     printf("\033[1m\033[34mThis line is emphasized and appears larger!\033[0m\n");  // Bold + Blue for emphasis
//     printf("\033[1m\033[31mThis is another normal line.\033[0m\n");                 // Another regular line

//     // ASCII art to simulate larger text
//     printf("\n\n\033[1m\033[32m");  // Set bold and green color
//     printf("#####     ###    ##   ##   ###### \n");
//     printf("    #    #   #   ###  ##   #      \n");
//     printf("    #    #   #   # #  ##   #####  \n");
//     printf("    #    #   #   #  # ##   #      \n");
